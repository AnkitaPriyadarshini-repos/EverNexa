    ...
    <div className="p-6 lg:p-10 max-w-5xl mx-auto space-y-8 animate-fade-in text-white font-sans">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {[
          ...
          { name: "Roblox", cat: "Casual", rating: 4.6 },
          { name: "Forge of Empires: Build a City", cat: "Strategy", rating: 4.7 }
        ].map((game, idx) => (
          <div key={idx} className="bg-[#18181B] border border-slate-800 rounded-2xl p-4 flex items-center justify-between hover:border-slate-700 transition-all">
            ...
            <button className="bg-[#252528] hover:bg-[#323236] text-sky-400 font-extrabold text-xs px-4 py-1.5 rounded-full uppercase tracking-wider">
              GET
            </button>
          </div>
        ))}
