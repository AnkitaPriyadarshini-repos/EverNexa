export const FEATURED_TODAY = [
  {
    ...
    apps: [
      { name: "ChatGPT", category: "Productivity", icon: "https://images.unsplash.com/photo-1677442136019-21780efad99a?auto=format&fit=crop&w=200&q=80" },
      { name: "Claude AI", category: "Productivity", icon: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?auto=format&fit=crop&w=200&q=80" },
      { name: "Midjourney AI", category: "Graphics & Design", icon: "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&w=200&q=80" }
    ]
  },
  {
    id: "story-pokemon",
    ...
    apps: [
      { name: "Pokémon GO", category: "Augmented Reality", icon: "https://images.unsplash.com/photo-1613771404784-3a5686aa2be3?auto=format&fit=crop&w=200&q=80" },
      { name: "Pokémon Sleep", category: "Health & Fitness", icon: "https://images.unsplash.com/photo-1542751371-adc38448a05e?auto=format&fit=crop&w=200&q=80" },
      { name: "Pokémon UNITE", category: "Strategy", icon: "https://images.unsplash.com/photo-1550745165-9bc0b252726f?auto=format&fit=crop&w=200&q=80" },
      { name: "Pokémon TCG Live", category: "Card Game", icon: "https://images.unsplash.com/photo-1607604276583-eef5d076aa5f?auto=format&fit=crop&w=200&q=80" }
    ]
  },
  {
    id: "story-adobe",
    ...
    storyId: "id1827352615",
    apps: [
      { name: "Adobe Photoshop", category: "Photo & Video", icon: "https://images.unsplash.com/photo-1572044162444-ad60f128bdea?auto=format&fit=crop&w=200&q=80" },
      { name: "Lightroom Photo Editor", category: "Photo & Video", icon: "https://images.unsplash.com/photo-1542744094-3a3121699497?auto=format&fit=crop&w=200&q=80" },
      { name: "Adobe Premiere AI", category: "Video Editing", icon: "https://images.unsplash.com/photo-1536240478700-b869070f9279?auto=format&fit=crop&w=200&q=80" },
      { name: "Adobe Express", category: "Design", icon: "https://images.unsplash.com/photo-1626785774573-4b799315345d?auto=format&fit=crop&w=200&q=80" }
    ]
  },
  {
    id: "story-roblox",
    cardType: "HERO_ROBLOX",
    eyebrow: "LET’S PLAY",
    title: "Play these great Roblox games this summer!",
    subtitle: "A universe of worlds just waiting to be explored.",
    storyId: "id1896768995",
...
export const CATS_GAMES = [
  { name: "Catagrams", category: "Word Puzzle", rating: 4.8 },
  { name: "Cat Quest III", category: "Action RPG", rating: 4.9 },
  { name: "Exploding Kittens® 2", category: "Card Game", rating: 4.7 },
  { name: "Neko Atsume 2", category: "Casual", rating: 4.8 },
  { name: "Super Phantom Cat 2", category: "Platformer", rating: 4.6 }
];
...
export const CATEGORIES_LIST = [
  ...
  { id: "health_fitness", name: "Health & Fitness", icon: "Activity" },
  { id: "productivity", name: "Productivity", icon: "Send" },
  { id: "entertainment", name: "Entertainment", icon: "Tv" },
  { id: "food_drink", name: "Food & Drink", icon: "UtensilsCrossed", targetApp: "1049305223" },
