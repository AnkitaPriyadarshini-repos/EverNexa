  ...
  return (
    <div className="p-6 lg:p-10 max-w-5xl mx-auto space-y-8 animate-fade-in text-white font-sans">
      ...
      <Link 
        ...
        className="bg-gradient-to-r from-yellow-500/20 to-red-600/20 border border-yellow-500/40 rounded-3xl p-6 flex items-center justify-between gap-4 cursor-pointer hover:border-yellow-400 transition-all block"
      >
