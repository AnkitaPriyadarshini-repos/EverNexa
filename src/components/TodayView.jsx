...
import { DandelionArt } from "./DandelionArt";
import { PikachuArt } from "./PikachuArt";
import { Sparkles, ArrowRight, Star, ChevronRight } from "lucide-react";

export const TodayView = () => {
  const { navigateToApp, setIsSimulatorOpen, setActiveStory } = useAppStore();
  ...
  const handleEventStory = (eventObj) => {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-6xl mx-auto space-y-10 animate-fade-in text-white font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {/* Hero Card 1: 3 AI apps we love (Exact Dandelion Artwork from Screenshot 4!) */}
        <div
        ...
        >
          ...
          <div className="relative z-20 p-5 bg-[#18181A]/95 backdrop-blur-md border-t border-white/10 flex items-center gap-3">
            ...
            {/* 2. Claude AI Icon (Black square with white asterisk) */}
            ...
            {/* 3. Midjourney Icon (Orange/pink gradient square) */}
        ...
        {/* Hero Card 2: Discover Pokémon on the App Store (Exact Pikachu Artwork from Screenshot 4!) */}
        <div
        ...
        >
          {/* Pikachu Vector Background Artwork */}
          <div className="absolute inset-0 z-0">
            <PikachuArt />
          </div>
          ...
          {/* Bottom Bar: 6 Pokémon App Icons (Exact as in Screenshot 4!) */}
      ...
      {/* Featured App Spotlight: Twenty Four Seven */}
      <div 
      ...
      {/* Today's Biggest Events Section (Matching Screenshot 4!) */}
